...
public class ZEDLiveLinkFusionTarget : TargetRules
{
	/// <summary>
	...
	public ZEDLiveLinkFusionTarget(TargetInfo Target) : base(Target)
	{
		...
		this.LaunchModuleName = "ZEDLiveLinkFusion";
		...
		string PostBuildBinDir = Path.Combine(DefaultBinDir, "ZEDLiveLinkFusion");
		if (Target.Platform.ToString() == "Win64")
		{
			...
			PostBuildSteps.Add(string.Format("xcopy /y /i /v \"{0}\\{1}.*\" \"{2}\" 1>nul", ConfigFilePath, "ZEDFusionLiveLinkConfig", PostBuildBinDir));
		}
	}
}